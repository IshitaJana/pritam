...
module.exports.CompanyRegister=(req,res,next)=>{
  ...
  company.SavedForm.form1.city=req.body.SavedForm.form1.city;
  company.SavedForm.form1.pincode=req.body.SavedForm.form1.pincode;
  company.NewForm.form1.city=req.body.NewForm.form1.city;
  company.NewForm.form1.pincode=req.body.NewForm.form1.pincode;
  company.SentForm.form1.city=req.body.SentForm.form1.city;
  company.SentForm.form1.pincode=req.body.SentForm.form1.pincode;
